            ...
            <div className="block rounded-lg bg-slate-200 shadow-lg ">
              <div className="g-0 lg:flex lg:flex-wrap">
                ...
                <div className="px-4 md:px-0 lg:w-6/12">
                  ...
                  <button type="submit" class="border-solid border-2 border-sky-500 w-full text-black bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign in</button>
