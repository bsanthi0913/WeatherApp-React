...
export default function SideBar(props) {
  ...
  useEffect(() => {
    if (props.data && props.data.currentConditions) {
      ...
      updateSideBar(
        props.data.currentConditions.temp,
        address.name,
        address.country,
        props.data.currentConditions.icon,
  ...
  function searchLocations(inputValue) {
    ...
    for (let i = 0; i < inputValue.length; i++) {
      ...
      else filter_input += inputValue[i];
    }
          ...
          <tbody>
            <tr>
              <td className="image-cell">
                <img
                  id="image1-sidebar"
                  src={`./weather-icons/${icon1}.svg`}
                  alt="Image 1"
                />
              </td>
              <td className="text-cell" id="image1-text">
                Sun ,Dec 24{" "}
              </td>
            </tr>
          </tbody>
          ...
          <tbody>
            <tr className="row2">
              <td className="image-cell">
                <img
                  id="image2-sidebar"
                  src={`./weather-icons/${icon2}.svg`}
                  alt="Image 2"
                />
              </td>
              <td className="text-cell" id="image2-text">
                Mon ,Dec 25{" "}
              </td>
            </tr>
          </tbody>
